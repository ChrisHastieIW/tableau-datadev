...
//(function () {
  ...
  $(document).ready(function () {
    ...
    // When #applyNewFilterButton is clicked:
    $("#filtersTable").on("click", ".applyNewFilterButotn", function() {

      let worksheetName = $(this).closest("tr").data("worksheet-name");
      let filterFieldName = $(this).closest("tr").data("filter-field-name");
      applyNewFilterButton(worksheetName, filterFieldName, values);
  ...
  */
  ...
  function updateSheetFilter(worksheet, filterFieldName, values, updateType) {
    return worksheet.applyFilterAsync(filterFieldName, values, updateType);
  }

  function applyNewFilterButton(worksheetName, filterFieldName, values) {
    ...
    .then(function(worksheet) {
      updateSheetFilter(worksheet, filterFieldName, values, tableau.FilterUpdateType.REPLACE)
    })
    .then(function() {
      retrieveFilters();
    })
  ...
  function clearFilter(worksheet, filterFieldName) {
    return updateSheetFilter(worksheet, filterFieldName, "", tableau.FilterUpdateType.ALL)
  }
